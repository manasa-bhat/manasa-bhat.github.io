...
echo $query;
    ...
    $query = "SELECT COUNT(*) FROM student  WHERE lastname like '$search'"; 
}
else if($column == 'usn') { 
    $query = "SELECT COUNT(*) FROM student  WHERE usn like '$search'"; 
}
else if($column == 'address') { 
    $query = "SELECT COUNT(*) FROM student  WHERE address like '$search'"; 
}
else if($column == 'university') { 
    $query = "SELECT COUNT(*) FROM student  WHERE university like '$search'"; 
}
else if($column == 'datetime') { 
    $query = "SELECT COUNT(*) FROM student  WHERE datetime like '$search'"; 
}
